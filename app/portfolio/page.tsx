...
const companies = [
  {
    ...
    body: "視空間認知能力の評価・トレーニングを通じて社会課題解決に取り組むスタートアップ。教習所・療育・労災の分野でPoCを実施し、シード〜プレシリーズAで累計1億円超を調達。複数の大手企業との業務提携も進む。",
  ...
  },
  {
    ...
    body: "更年期女性の健康課題に向き合うヘルステック企業。骨密度×美容の観点から「骨ケア」サービスを展開。旭化成ファーマと連携し、2025年設立。検診センターや自治体との実証実験が進行中。",
